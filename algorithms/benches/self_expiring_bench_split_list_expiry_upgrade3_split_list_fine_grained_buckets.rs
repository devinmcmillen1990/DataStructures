use algorithms::self_expiring::split_list_with_expiry::upgrade3::split_list_fine_grained_buckets::SplitListFineGrainedBuckets;
...
fn bench_insert_split_list(c: &mut Criterion) {
    ...
    for &volume in &[10_000, 100_000, 1_000_000] {
        ...
        group.bench_with_input(BenchmarkId::new("Insert", volume), &volume, |b, &volume| {
            b.iter(|| {
                let expiry = SplitListFineGrainedBuckets::new();
                for i in 0..volume {
