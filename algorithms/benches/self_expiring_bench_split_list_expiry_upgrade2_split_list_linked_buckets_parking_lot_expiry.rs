use algorithms::self_expiring::split_list_with_expiry::upgrade2::split_list_linked_buckets_parking_lot_expiry::SplitListLinkedBucketsParkingLotExpiry;
...
fn bench_insert_split_list(c: &mut Criterion) {
    ...
    for &volume in &[10_000, 100_000, 1_000_000] {
        ...
        group.bench_with_input(BenchmarkId::new("Insert", volume), &volume, |b, &volume| {
            b.iter(|| {
                let expiry = SplitListLinkedBucketsParkingLotExpiry::new();
                for i in 0..volume {
