use algorithms::self_expiring::real_time_queues::prototype::thread_local_prealloc_expiry::PrototypeThreadLocalExpiry;
    ...
    for &volume in &[10_000, 100_000, 1_000_000] {
        ...
        group.bench_with_input(BenchmarkId::new("Insert", volume), &volume, |b, &volume| {
            b.iter(|| {
                ...
                let expiry = PrototypeThreadLocalExpiry::new(optimal_threads);
                for i in 0..volume {
